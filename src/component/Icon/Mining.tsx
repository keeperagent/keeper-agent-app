...
// https://www.flaticon.com/search?word=mining&weight=regular&corner=rounded&type=uicon

const MiningIcon = (props: IIconProps) => {
  const {
    color = "#6e6b7b",
    width = 512,
    height = 512,
