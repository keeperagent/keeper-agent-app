...
// https://www.flaticon.com/search?word=node&weight=regular&corner=rounded&type=uicon

const NetworkCircleIcon = (props: IIconProps) => {
  const {
    color = "#6e6b7b",
    width = 512,
    height = 512,
...
export default NetworkCircleIcon;
