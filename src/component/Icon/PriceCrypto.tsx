...
// https://www.flaticon.com/search?word=growth%20crypto&weight=regular&corner=rounded&type=uicon

const PriceCryptoIcon = (props: IIconProps) => {
  const {
    color = "#E72929",
    width = 512,
    height = 512,
...
export default PriceCryptoIcon;
