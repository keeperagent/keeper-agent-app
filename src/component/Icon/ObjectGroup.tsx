...
// https://www.flaticon.com/free-icon-fonts/object-group

const ObjectGroupIcon = (props: IIconProps) => {
  const {
    color = "#6e6b7b",
    width = 512,
    height = 512,
