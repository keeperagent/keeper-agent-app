...
// https://www.flaticon.com/search?word=document-story&weight=regular&corner=rounded&type=uicon

const DocumentStoryIcon = (props: IIconProps) => {
  const {
    color = "#6e6b7b",
    width = 512,
    height = 512,
...
export default DocumentStoryIcon;
