...
const getVariablesFromNodes = (
  nodes: Node[],
  translate: any,
  selectedCampaign?: ICampaign | null,
): { [key: string]: IWorkflowVariable } => {
    ...
    switch ((node?.data?.config as any)?.workflowType) {
      ...
      case WORKFLOW_TYPE.SET_ATTRIBUTE: {
        ...
        const variable: IWorkflowVariable = {
          ...
          sourceLabel: `${translate("from")} ${SCRIPT_NAME_EN[WORKFLOW_TYPE.SET_ATTRIBUTE]} Processor`,
        };
      ...
      case WORKFLOW_TYPE.CRAWL_TEXT: {
        ...
        const variable: IWorkflowVariable = {
          variable: config?.variable || "",
          sourceLabel: `${translate("from")} ${SCRIPT_NAME_EN[WORKFLOW_TYPE.CRAWL_TEXT]} Processor`,
        };
      ...
      case WORKFLOW_TYPE.GET_RANDOM_VALUE: {
        ...
        const variable: IWorkflowVariable = {
          variable: config?.variable || "",
          sourceLabel: `${translate("from")} ${SCRIPT_NAME_EN[WORKFLOW_TYPE.GET_RANDOM_VALUE]} Processor`,
        };
      ...
      case WORKFLOW_TYPE.CHECK_ELEMENT_EXIST: {
        ...
        const variable: IWorkflowVariable = {
          variable: config?.variable || "",
          sourceLabel: `${translate("from")} ${SCRIPT_NAME_EN[WORKFLOW_TYPE.CHECK_ELEMENT_EXIST]} Processor`,
        };
      ...
      case WORKFLOW_TYPE.GET_GAS_PRICE: {
        ...
        const variable: IWorkflowVariable = {
          variable: config?.variable || "",
          sourceLabel: `${translate("from")} ${SCRIPT_NAME_EN[WORKFLOW_TYPE.GET_GAS_PRICE]} Processor`,
        };
      ...
      case WORKFLOW_TYPE.GET_WALLET_BALANCE: {
        ...
        const variable: IWorkflowVariable = {
          variable: config?.variable || "",
          sourceLabel: `${translate("from")} ${SCRIPT_NAME_EN[WORKFLOW_TYPE.GET_WALLET_BALANCE]} Processor`,
        };
      ...
      case WORKFLOW_TYPE.CALCULATE: {
        ...
        const variable: IWorkflowVariable = {
          variable: config?.variable || "",
          sourceLabel: `${translate("from")} ${SCRIPT_NAME_EN[WORKFLOW_TYPE.CALCULATE]} Processor`,
        };
      ...
      case WORKFLOW_TYPE.TRANSFER_TOKEN: {
        ...
        const variable: IWorkflowVariable = {
          variable: config?.variable || "",
          sourceLabel: `${translate("from")} ${SCRIPT_NAME_EN[WORKFLOW_TYPE.TRANSFER_TOKEN]} Processor`,
        };
      ...
      case WORKFLOW_TYPE.EVM_APPROVE_REVOKE_TOKEN: {
        ...
        const variable: IWorkflowVariable = {
          variable: config?.variable || "",
          sourceLabel: `${translate("from")} ${SCRIPT_NAME_EN[WORKFLOW_TYPE.EVM_APPROVE_REVOKE_TOKEN]} Processor`,
        };
      ...
      case WORKFLOW_TYPE.EVM_SNIPE_CONTRACT: {
        ...
        listVariable?.forEach((variableName) => {
          const variable: IWorkflowVariable = {
            ...
            sourceLabel: `${translate("from")} ${SCRIPT_NAME_EN[WORKFLOW_TYPE.EVM_SNIPE_CONTRACT]} Processor`,
          };
      ...
      case WORKFLOW_TYPE.EVM_WRITE_TO_CONTRACT: {
        ...
        const variable: IWorkflowVariable = {
          variable: config?.variable || "",
          sourceLabel: `${translate("from")} ${SCRIPT_NAME_EN[WORKFLOW_TYPE.EVM_WRITE_TO_CONTRACT]} Processor`,
        };
      ...
      case WORKFLOW_TYPE.EVM_READ_FROM_CONTRACT: {
        ...
        listVariable?.forEach((variableName) => {
          const variable: IWorkflowVariable = {
            variable: variableName,
            sourceLabel: `${translate("from")} ${SCRIPT_NAME_EN[WORKFLOW_TYPE.EVM_READ_FROM_CONTRACT]} Processor`,
          };
      ...
      case WORKFLOW_TYPE.EXECUTE_TRANSACTION: {
        ...
        const variable: IWorkflowVariable = {
          variable: config?.variable || "",
          sourceLabel: `${translate("from")} ${SCRIPT_NAME_EN[WORKFLOW_TYPE.EXECUTE_TRANSACTION]} Processor`,
        };
      ...
      case WORKFLOW_TYPE.CONVERT_TOKEN_AMOUNT: {
        ...
        const variable: IWorkflowVariable = {
          variable: config?.variable || "",
          sourceLabel: `${translate("from")} ${SCRIPT_NAME_EN[WORKFLOW_TYPE.CONVERT_TOKEN_AMOUNT]} Processor`,
        };
      ...
      case WORKFLOW_TYPE.GET_TOKEN_PRICE: {
        ...
        const variable: IWorkflowVariable = {
          variable: config?.variable || "",
          sourceLabel: `${translate("from")} ${SCRIPT_NAME_EN[WORKFLOW_TYPE.GET_TOKEN_PRICE]} Processor`,
        };
      ...
      case WORKFLOW_TYPE.EXECUTE_CODE: {
        ...
        const variable: IWorkflowVariable = {
          variable: config?.variable || "",
          sourceLabel: `${translate("from")} ${SCRIPT_NAME_EN[WORKFLOW_TYPE.EXECUTE_CODE]} Processor`,
        };
      ...
      case WORKFLOW_TYPE.SELECT_WALLET: {
        ...
        listVariable?.forEach((variableName) => {
          const variable: IWorkflowVariable = {
            variable: variableName,
            sourceLabel: `${translate("from")} ${SCRIPT_NAME_EN[WORKFLOW_TYPE.SELECT_WALLET]} Processor`,
          };
      ...
      case WORKFLOW_TYPE.CHECK_RESOURCE: {
        const variable: IWorkflowVariable = {
          ...
          sourceLabel: `${translate("from")} ${SCRIPT_NAME_EN[WORKFLOW_TYPE.CHECK_RESOURCE]} Processor`,
        };
      ...
      case WORKFLOW_TYPE.GENERATE_VANITY_ADDRESS: {
        ...
        const addressVariable: IWorkflowVariable = {
          ...
          sourceLabel: `${translate("from")} ${SCRIPT_NAME_EN[WORKFLOW_TYPE.GENERATE_VANITY_ADDRESS]} Processor`,
        };
