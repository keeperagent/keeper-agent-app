...
import { ISwitchMartianWalletNodeConfig } from "@/electron/type";
import {
...
type Props = {
  onCloseModal: () => any;
  onSaveNodeConfig: (config: ISwitchMartianWalletNodeConfig) => void;
  config: ISwitchMartianWalletNodeConfig;
  isModalOpen: boolean;
};

const MartianWalletSwitch = (props: Props) => {
...
export default MartianWalletSwitch;
