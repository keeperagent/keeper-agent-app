...
import { IUnlockPhantomWalletNodeConfig } from "@/electron/type";
...
type Props = {
  onCloseModal: () => any;
  onSaveNodeConfig: (config: IUnlockPhantomWalletNodeConfig) => void;
  config: IUnlockPhantomWalletNodeConfig;
  isModalOpen: boolean;
};

const PhantomWalletUnlock = (props: Props) => {
...
export default PhantomWalletUnlock;
