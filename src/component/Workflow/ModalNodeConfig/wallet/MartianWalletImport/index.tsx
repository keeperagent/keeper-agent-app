...
import { IImportMartianWalletNodeConfig } from "@/electron/type";
import {
...
import { WALLET_VARIABLE, NODE_STATUS } from "@/electron/constant";
...
type Props = {
  onCloseModal: () => any;
  onSaveNodeConfig: (config: IImportMartianWalletNodeConfig) => void;
  config: IImportMartianWalletNodeConfig;
  isModalOpen: boolean;
};

const MartianWalletImport = (props: Props) => {
...
export default MartianWalletImport;
