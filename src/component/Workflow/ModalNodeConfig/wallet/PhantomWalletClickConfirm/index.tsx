...
import { IClickConfirmPhantomWalletNodeConfig } from "@/electron/type";
import {
...
type Props = {
  onCloseModal: () => any;
  onSaveNodeConfig: (config: IClickConfirmPhantomWalletNodeConfig) => void;
  config: IClickConfirmPhantomWalletNodeConfig;
  isModalOpen: boolean;
};

const PhantomWalletClickConfirm = (props: Props) => {
...
export default PhantomWalletClickConfirm;
