...
import { ICancelRabbyWalletNodeConfig } from "@/electron/type";
import {
...
type Props = {
  onCloseModal: () => any;
  onSaveNodeConfig: (config: ICancelRabbyWalletNodeConfig) => void;
  config: ICancelRabbyWalletNodeConfig;
  isModalOpen: boolean;
};

const RabbyWalletCancel = (props: Props) => {
...
export default RabbyWalletCancel;
