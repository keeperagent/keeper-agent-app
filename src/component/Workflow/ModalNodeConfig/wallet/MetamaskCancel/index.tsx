...
import { ICancelMetamaskNodeConfig } from "@/electron/type";
...
type Props = {
  onCloseModal: () => any;
  onSaveNodeConfig: (config: ICancelMetamaskNodeConfig) => void;
  config: ICancelMetamaskNodeConfig;
  isModalOpen: boolean;
};

const MetamaskCancel = (props: Props) => {
