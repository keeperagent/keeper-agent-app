...
type Props = {
  onCloseModal: () => any;
  onSaveNodeConfig: (config: IGetWalletBalanceNodeConfig) => void;
  config: IGetWalletBalanceNodeConfig;
  isModalOpen: boolean;
  listNodeEndpointGroup: INodeEndpointGroup[];
};

const GetWalletBalance = (props: Props) => {
  ...
  useEffect(() => {
    form.setFieldsValue({
      ...
      variable: config?.variable || "WALLET_BALANCE",
        ...
        {activeTab === TAB.DETAIL && (
          <Fragment>
            ...
            <div className="token-mode">
              ...
              {/* {chainType === CHAIN_TYPE.EVM && (
                <TagOption
                  content={TOKEN_TYPE_NAME[TOKEN_TYPE.EVM_NFT_TOKEN]}
                  checked={mode === TOKEN_TYPE.EVM_NFT_TOKEN}
                  onClick={() => setMode(TOKEN_TYPE.EVM_NFT_TOKEN)}
                  style={{ fontSize: "1.1rem" }}
                />
              )} */}
              ...
              {/* {chainType === CHAIN_TYPE.APTOS && (
                <TagOption
                  content={TOKEN_TYPE_NAME[TOKEN_TYPE.APTOS_TOKEN]}
                  checked={mode === TOKEN_TYPE.APTOS_TOKEN}
                  onClick={() => setMode(TOKEN_TYPE.APTOS_TOKEN)}
                  style={{ fontSize: "1.1rem" }}
                />
              )} */}
              ...
              {/* {chainType === CHAIN_TYPE.SUI && (
                <TagOption
                  content={TOKEN_TYPE_NAME[TOKEN_TYPE.SUI_NFT]}
                  checked={mode === TOKEN_TYPE.SUI_NFT}
                  onClick={() => setMode(TOKEN_TYPE.SUI_NFT)}
                  style={{ fontSize: "1.1rem" }}
                />
              )} */}
              ...
              {/* {chainType === CHAIN_TYPE.SOLANA && (
                <TagOption
                  content={TOKEN_TYPE_NAME[TOKEN_TYPE.SOLANA_NFT]}
                  checked={mode === TOKEN_TYPE.SOLANA_NFT}
                  onClick={() => setMode(TOKEN_TYPE.SOLANA_NFT)}
                  style={{ fontSize: "1.1rem" }}
                />
              )} */}
            </div>
