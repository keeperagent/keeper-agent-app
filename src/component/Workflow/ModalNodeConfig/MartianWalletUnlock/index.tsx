...
import { IUnlockMartianWalletNodeConfig } from "@/electron/type";
...
type Props = {
  onCloseModal: () => any;
  onSaveNodeConfig: (config: IUnlockMartianWalletNodeConfig) => void;
  config: IUnlockMartianWalletNodeConfig;
  isModalOpen: boolean;
};

const MartianWalletUnlock = (props: Props) => {
...
export default MartianWalletUnlock;
