...
import { IReTweetTwitterNodeConfig } from "@/electron/type";
...
type Props = {
  onCloseModal: () => any;
  onSaveNodeConfig: (config: IReTweetTwitterNodeConfig) => void;
  config: IReTweetTwitterNodeConfig;
  isModalOpen: boolean;
};

const TwitterReTweet = (props: Props) => {
  ...
  useEffect(() => {
    form.setFieldsValue({
      ...
      action: config?.action || RETEET_TWITTER_ACTION.RETWEET,
      sleep: config?.sleep,
            ...
            >
              <Select
                ...
                options={[
                  {
                    label: "ReTweet",
                    value: RETEET_TWITTER_ACTION.RETWEET,
                  },
                  {
                    label: "Undo ReTweet",
                    value: RETEET_TWITTER_ACTION.UNDO_RETWEET,
                  },
                ]}
              />
            </Form.Item>
