...
import { IUnlockRabbyWalletNodeConfig } from "@/electron/type";
...
type Props = {
  onCloseModal: () => any;
  onSaveNodeConfig: (config: IUnlockRabbyWalletNodeConfig) => void;
  config: IUnlockRabbyWalletNodeConfig;
  isModalOpen: boolean;
};

const RabbyWalletUnlockWallet = (props: Props) => {
...
export default RabbyWalletUnlockWallet;
