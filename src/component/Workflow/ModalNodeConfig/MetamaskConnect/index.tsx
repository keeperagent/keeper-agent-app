...
import { IConnectMetamaskNodeConfig } from "@/electron/type";
import {
...
type Props = {
  onCloseModal: () => any;
  onSaveNodeConfig: (config: IConnectMetamaskNodeConfig) => void;
  config: IConnectMetamaskNodeConfig;
  isModalOpen: boolean;
};

const MetamaskConnect = (props: Props) => {
