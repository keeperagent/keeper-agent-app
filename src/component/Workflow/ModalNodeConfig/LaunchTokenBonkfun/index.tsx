...
import solImg from "@/asset/sol.png";
import usd1Img from "@/asset/usd1.png";
...
type Props = {
  onCloseModal: () => any;
  onSaveNodeConfig: (config: ILaunchTokenBonkfunNodeConfig) => void;
  config: ILaunchTokenBonkfunNodeConfig;
  isModalOpen: boolean;
  listNodeEndpointGroup: INodeEndpointGroup[];
};

const LaunchTokenBonkfun = (props: Props) => {
  ...
  const [launchCurrency, setLaunchCurrency] = useState(
  ...
  useEffect(() => {
    form.setFieldsValue({
      ...
      variableTxHash: config?.variableTxHash || "TX_HASH_LAUNCH_TOKEN_BONKFUN",
      ...
      unitLimit: config?.unitLimit || "250000",
        ...
        {activeTab === TAB.DETAIL && (
          <Fragment>
            ...
            <Row gutter={16}>
              ...
              <Col span={12}>
                <Form.Item
                  label={translate("workflow.launchCurrency")}
                  name="launchCurrency"
                  rules={[
                    {
                      required: true,
                ...
                >
                  <Select
                    placeholder={translate(
                      "workflow.launchCurrencyPlaceholder",
                    )}
                    size="large"
                    className="custom-select"
                    onSearch={onSearchNodeEndpointGroup}
                    filterOption={false}
                    optionLabelProp="label"
                    onChange={(value) => setLaunchCurrency(value)}
                  >
                    <Option
                      key={BONKFUN_LAUNCH_CURRENCY.SOL}
                      value={BONKFUN_LAUNCH_CURRENCY.SOL}
                      label={
                        <ChainWrapper>
                          <div className="icon">
                            <img src={solImg} alt="" />
                    ...
                    >
                      <OptionWrapper>
                        ...
                        <div className="content">
                          <div className="name">SOL</div>
                        </div>
                      </OptionWrapper>
                    </Option>

                    <Option
                      key={BONKFUN_LAUNCH_CURRENCY.USD1}
                      value={BONKFUN_LAUNCH_CURRENCY.USD1}
                      label={
                        <ChainWrapper>
                          <div className="icon">
                            <img src={usd1Img} alt="" />
                          </div>
                          <span className="text">USD1</span>
                        </ChainWrapper>
                      }
                    >
                      <OptionWrapper>
              ...
              <Col span={12}>
                <Form.Item
                  label={
                    <FormLabelWrapper>
                      <span className="text">
                        {launchCurrency === BONKFUN_LAUNCH_CURRENCY.SOL
                          ? translate("workflow.buyAmountInSol")
                          : translate("workflow.buyAmountInUsd1")}
                        :
                      </span>
