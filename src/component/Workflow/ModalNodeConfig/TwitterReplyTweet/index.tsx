...
import { IReplyTweetTwitterNodeConfig } from "@/electron/type";
...
type Props = {
  onCloseModal: () => any;
  onSaveNodeConfig: (config: IReplyTweetTwitterNodeConfig) => void;
  config: IReplyTweetTwitterNodeConfig;
  isModalOpen: boolean;
};

const TwitterReplyTweet = (props: Props) => {
      ...
      <Form layout="vertical" form={form} initialValues={{ sleep: 0 }}>
        {activeTab === TAB.DETAIL && (
          <Fragment>
            ...
            <Form.Item
              label={
                <FormLabelWrapper>
                  ...
                  <WorkflowVariable form={form} fieldName="comment" />
                </FormLabelWrapper>
              }
              name="comment"
              rules={[
            ...
            >
              <TextArea
                placeholder={translate("workflow.commentPlaceholder")}
                className="custom-input"
                size="large"
                rows={3}
              />
...
export default TwitterReplyTweet;
