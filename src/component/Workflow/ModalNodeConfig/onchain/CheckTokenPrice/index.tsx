...
import { listCondition } from "@/component/Workflow/ModalNodeConfig/flow/CheckCondition";
...
type Props = {
  onCloseModal: () => any;
  onSaveNodeConfig: (config: ICheckTokenPriceNodeConfig) => void;
  config: ICheckTokenPriceNodeConfig;
  isModalOpen: boolean;
  isLightMode: boolean;
};

const CheckTokenPrice = (props: Props) => {
  ...
  useEffect(() => {
    form.setFieldsValue({
      ...
      variable: config?.variable || "CHECK_PRICE_RESULT",
              ...
              title={
                <span>
                  <span style={{ marginLeft: "0.5rem" }}>
                    {translate("workflow.checkTokenPriceHelper1")}:
                  </span>
                  <br />
                  <Code
            ...
            <Row gutter={16}>
              ...
              <Col span={12}>
                ...
                >
                  <InputNumber
                    placeholder={translate(
                      "workflow.timeFrameCheckPricePlaceholder",
                    )}
                    className="custom-input"
                    size="large"
                    style={{ width: "100%" }}
