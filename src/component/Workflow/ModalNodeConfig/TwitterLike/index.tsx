...
type Props = {
  onCloseModal: () => any;
  onSaveNodeConfig: (config: ILikeTwitterNodeConfig) => void;
  config: ILikeTwitterNodeConfig;
  isModalOpen: boolean;
};

const TwitterLike = (props: Props) => {
  ...
  useEffect(() => {
    form.setFieldsValue({
      ...
      action: config?.action || LIKE_TWITTER_ACTION.LIKE,
      sleep: config?.sleep,
            ...
            <Form.Item
              label={
                <FormLabelWrapper>
                  ...
                  <WorkflowVariable form={form} fieldName="tweetUrl" />
                </FormLabelWrapper>
              }
              name="tweetUrl"
              rules={[
            ...
            >
              <Select
                ...
                options={[
                  {
                    label: "Like",
                    value: LIKE_TWITTER_ACTION.LIKE,
                  },
                  {
                    label: "UnLike",
                    value: LIKE_TWITTER_ACTION.UNLIKE,
                  },
                ]}
              />
            </Form.Item>
