...
import { IApproveMartianWalletNodeConfig } from "@/electron/type";
import {
...
type Props = {
  onCloseModal: () => any;
  onSaveNodeConfig: (config: IApproveMartianWalletNodeConfig) => void;
  config: IApproveMartianWalletNodeConfig;
  isModalOpen: boolean;
};

const MartianWalletApprove = (props: Props) => {
...
export default MartianWalletApprove;
