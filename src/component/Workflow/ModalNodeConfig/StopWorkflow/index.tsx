...
import { IStopWorkflowNodeConfig } from "@/electron/type";
...
type Props = {
  onCloseModal: () => any;
  onSaveNodeConfig: (config: IStopWorkflowNodeConfig) => void;
  config: IStopWorkflowNodeConfig;
  isModalOpen: boolean;
};

const StopWorkflow = (props: Props) => {
