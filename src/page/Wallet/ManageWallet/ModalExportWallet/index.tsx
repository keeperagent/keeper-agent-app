...
import { useExportWallet } from "@/hook/wallet";
import { PasswordInput } from "@/component/Input";
import { ModalWrapper, IconWrapper } from "./style";

const cacheItemName = "exportWalletFolderPath";

const ModalExportWallet = (props: any) => {
  const { translate } = useTranslation();
  const { isModalOpen, setModalOpen, selectedWalletGroup, listWalletId } =
    props;

  const { exportWallet, loading, isSuccess } = useExportWallet();
