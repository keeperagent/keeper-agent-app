...
import { useChooseFolder, useExportResource, useTranslation } from "@/hook";
import { PasswordInput } from "@/component/Input";
import { ModalWrapper, IconWrapper } from "./style";

const cacheItemName = "exportResourceFolderPath";

const ModalExportResource = (props: any) => {
  const { translate } = useTranslation();
  const { isModalOpen, setModalOpen, selectedResourceGroup } = props;

  const { exportResource, loading, isSuccess } = useExportResource();
