...
Optional: imageUrl (URL or local file path), description, twitter, telegram, website, buyAmountSol, slippagePercentage, unitLimit, unitPrice, launchCurrency.`,
    schema: z.object({
      ...
      unitLimit: z.string().optional().default("250000").describe("Gas limit"),
      unitPrice: z
        .string()
        .optional()
        .default("100")
      ...
      launchCurrency: z
        ...
        .default("SOL")
        .optional()
        .describe("Launch pool currency: SOL or USD1"),
    }),
    func: async ({
      tokenName,
      symbol,
      ...
      logEveryWhere({
        message: `Bonk.fun token launched: ${tokenName} (${symbol}), Token Address: ${tokenAddress}, Transaction Hash: ${txHash}`,
      });
